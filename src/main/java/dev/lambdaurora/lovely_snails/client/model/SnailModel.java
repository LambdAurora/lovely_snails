...
public class SnailModel extends EntityModel<SnailEntityRenderState> {
	...
	public static LayerDefinition model(CubeDeformation deformation) {
		...
		buildAdultModel(root.addOrReplaceChild("adult", new CubeListBuilder(), PartPose.ZERO), deformation);
		buildBabyModel(root.addOrReplaceChild("baby", new CubeListBuilder(), PartPose.ZERO), deformation);
	...
	private static void buildAdultModel(PartDefinition root, CubeDeformation deformation) {
		var body = root.addOrReplaceChild(BODY, new CubeListBuilder()
						.texOffs(0, 32)
						.addBox(-(ADULT_FRONT_WIDTH / 2.f), 5.f, -20.f, ADULT_FRONT_WIDTH, 3.f, 40.f, deformation),
		...
		upperBody.addOrReplaceChild("left_tentacle", new CubeListBuilder()
						.texOffs(0, 2)
						.addBox(-ADULT_FRONT_WIDTH / 2.f, 0.f, -2.f, 4.f, 4.f, 2.f, deformation),
				PartPose.ZERO
		);
		upperBody.addOrReplaceChild("right_tentacle", new CubeListBuilder()
						.texOffs(0, 2)
						.mirror()
						.addBox(ADULT_FRONT_WIDTH / 2.f - 4.f, 0.f, -2.f, 4.f, 4.f, 2.f, deformation),
				PartPose.ZERO
		);
		...
		body.addOrReplaceChild(LEFT_EYE, new CubeListBuilder()
						.texOffs(42, 0)
						.addBox(-2.8336f, -15.849f, -3.8272f, ADULT_EYE_DIAMETER, ADULT_EYE_LENGTH, ADULT_EYE_DIAMETER, deformation),
				PartPose.offsetAndRotation(-1.5f, -4.f, -15f, 0.4363f, ADULT_EYE_YAW, 0.f));
		body.addOrReplaceChild(RIGHT_EYE, new CubeListBuilder()
						.texOffs(42, 0)
						.mirror()
						.addBox(0.8336f, -15.849f, -3.8272f, ADULT_EYE_DIAMETER, ADULT_EYE_LENGTH, ADULT_EYE_DIAMETER, deformation),
				PartPose.offsetAndRotation(1.5f, -4.f, -15f, 0.4363f, -ADULT_EYE_YAW, 0.f));
	}
	...
	private static void buildBabyModel(PartDefinition babyRoot, CubeDeformation deformation) {
		var body = babyRoot.addOrReplaceChild(BODY, new CubeListBuilder()
						.texOffs(56, 0)
						.addBox(-(BABY_FRONT_WIDTH / 2.f), 22.f, -7.f, BABY_FRONT_WIDTH, 2.f, 14.f, deformation)
						.texOffs(0, 10)
						.addBox(-(BABY_FRONT_WIDTH / 2.f), 20.f, -7.f, BABY_FRONT_WIDTH, 2.f, 4.f, deformation)
						.texOffs(0, 0)
						.addBox(-(BABY_FRONT_WIDTH / 2.f), 22.f, -8.f, 1.f, 1.f, 1.f, deformation)
						.addBox(BABY_FRONT_WIDTH / 2.f - 1.f, 22.f, -8.f, 1.f, 1.f, 1.f, deformation),
				PartPose.offset(0, 0, -2.f));
		babyRoot.addOrReplaceChild(SHELL, new CubeListBuilder()
						.texOffs(0, 32)
						.addBox(-3.f, 10.f, -1.f, 6.f, BABY_SHELL_DIAMETER, BABY_SHELL_DIAMETER, deformation),
				PartPose.offsetAndRotation(0.f, 2.2f, -3.f, BABY_SHELL_ROTATION, 0.f, 0.f));
		body.addOrReplaceChild(LEFT_EYE, new CubeListBuilder()
						.texOffs(0, 32)
						.addBox(-1.1664f, 19.f, -3.8272f, BABY_EYE_DIAMETER, BABY_EYE_LENGTH, BABY_EYE_DIAMETER, deformation),
				PartPose.offsetAndRotation(-1.5f, -4.f, -14.2f, 0.4363f, BABY_EYE_YAW, 0.f));
		body.addOrReplaceChild(RIGHT_EYE, new CubeListBuilder()
						.texOffs(0, 32)
						.mirror()
						.addBox(0.1664f, 19.f, -3.8272f, BABY_EYE_DIAMETER, BABY_EYE_LENGTH, BABY_EYE_DIAMETER, deformation),
				PartPose.offsetAndRotation(1.5f, -4.f, -14.2f, 0.4363f, -BABY_EYE_YAW, 0.f));
	}
	...
	public static class Model {
		...
		public void updateMatrix(PoseStack matrices) {
